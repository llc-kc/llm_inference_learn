...
- 路由函数：`sqrtsoftplus`：
  ...
  ```python
  scores = F.softplus(scores).sqrt()   # 默认score_func
  ```
...
```plain
Weight:  [out_features, in_features//2]   (float4_e2m1fn_x2)
